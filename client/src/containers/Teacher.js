...
const {email,password,Eemail,Epassword,
		name,branch,Ename,Ebranch,Erpassword,rpassword} = formData;
...
const onSubmit = async (e)=>{
    ...
    if(branch==="") {onChange("Ebranch",true);props.Alert("Department is required!","error"); return}
    ...
    <Container className="Container" component="main" maxWidth="xs" style={{textAlign:"center",display:"flex"}} > 
      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} noValidate onSubmit={onSubmit}>
          ...
          <AutoComplete list={BRANCH} label="Department" onInput={onChange} error={Ebranch}/>
           <TextField
            variant="outlined"
            margin="normal"
            required
